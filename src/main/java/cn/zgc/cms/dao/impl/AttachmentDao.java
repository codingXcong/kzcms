...
public class AttachmentDao extends BasicHibernateDaoImpl<Attachment> implements IAttachmentDao{
	...
	public long findNoUseAttachmentNum() {
		String hql = "select count(1) from Attachment a where a.topic is null";
